...
public class AthletePerformanceTest {
    ...
    public void shouldCalculateSprint100m() {
        AthletePerformance sprint100m = new AthletePerformance.Builder("Sprint100m")
                .sprint100m(13.04)
                .build();
    ...
    public void shouldCalculateLongJump() {
        AthletePerformance longJump = new AthletePerformance.Builder("LongJump")
                .longJump(5.00)
                .build();
    ...
    public void shouldCalculateShotPut() {
        AthletePerformance shotPut = new AthletePerformance.Builder("ShotPut")
                .shotPut(9.22)
                .build();
    ...
    public void shouldCalculateHighJump() {
        AthletePerformance highJump = new AthletePerformance.Builder("HighJump")
                .highJump(1.50)
                .build();
    ...
    public void shouldCalculate400m() {
        AthletePerformance sprint400m = new AthletePerformance.Builder("Sprint400m")
                .sprint400m(60.39)
                .build();
    ...
    public void shouldCalculate110mHurdles() {
        AthletePerformance sprint110mHurdles = new AthletePerformance.Builder("Sprint110mHurdles")
    ...
    public void shouldCalculateDiscusThrow() {
        AthletePerformance discusThrow = new AthletePerformance.Builder("DiscusThrow")
                .discusThrow(21.60)
                .build();
    ...
    public void shouldCalculatePoleVault() {
        AthletePerformance poleVault = new AthletePerformance.Builder("PoleVault")
                .poleVault(2.60)
                .build();
    ...
    public void shouldCalculateJavelinThrow() {
        AthletePerformance javelinThrow = new AthletePerformance.Builder("JavelinThrow")
                .javelinThrow(35.81)
                .build();
    ...
    public void shouldCalculateSprint1500m() {
        AthletePerformance javelinThrow = new AthletePerformance.Builder("JavelinThrow")
                .sprint1500m(LocalTime.of(0, 5, 25).toSecondOfDay())
                .build();
